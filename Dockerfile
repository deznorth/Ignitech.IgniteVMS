...
COPY ./src/IgniteVMS.Client/package.json ./
COPY ./src/IgniteVMS.Client/yarn.lock ./

RUN yarn

COPY ./src/IgniteVMS.Client ./
...
RUN chmod +x ./IgniteVMS

# ENTRYPOINT ["./IgniteVMS"]
CMD ASPNETCORE_URLS=http://*:$PORT ./IgniteVMS